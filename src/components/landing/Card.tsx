...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      className="w-[340px] h-[295px] relative bg-[#D9D9D9] rounded-[10px] max-md:mb-5 max-sm:w-full transition-all duration-1000"
      role="article"
      style={{
    ...
    >
      ...
      <button
        onClick={handleClick}
        className="text-2xl italic font-light text-[#1E1E1E] absolute -translate-x-2/4 w-[257px] h-[66px] bg-[#E6DADA] rounded-[22px] left-2/4 bottom-[9px] max-sm:w-4/5 hover:bg-[#7485d7] transition-colors duration-200 flex items-center justify-center"
      >
        Listing
      </button>
    </div>
