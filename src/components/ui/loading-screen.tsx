    ...
    <div className={`flex flex-col items-center justify-center ${fullScreen ? 'fixed inset-0 z-50 bg-[#F5F5F7]' : 'p-8'}`}>
      <div className="relative w-48 h-48 mb-4">
        ...
        <img 
          ...
          alt="TCG Updates" 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-auto z-10" 
        />
        {/* Spinning arrow animation */}
        <img 
          src="/lovable-uploads/d2ebd92a-d985-443a-aeef-7829896aad77.png" 
          alt="Loading" 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-auto animate-spin-slow" 
        />
      </div>
